...
public class PanelGlowny extends JFrame {
    ...
    private void initComponents() throws IOException, InterruptedException {
        ...
        jPanel1.setBorder(BorderFactory.createTitledBorder("Foldery"));
      ...
      /*  Runnable r2=new WaekKonsola(jTextArea1);
       ...
       jComboBox1.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        jComboBox1.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        jComboBox1.setModel(new DefaultComboBoxModel<>(new String[] { "C:/PicSwaper"  }));
     ...
     //   lol.
        ...
        jTextArea1.setBorder(BorderFactory.createTitledBorder("Serwer Log"));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jComboBox1, GroupLayout.PREFERRED_SIZE, 189, GroupLayout.PREFERRED_SIZE))
	...
	private static List<JWindow> listaRamki=new ArrayList<JWindow>();
	private static List<JWindow> Zdjecia=new ArrayList<JWindow>();
	...
	try {
		//List<JWindow> listaRamki=new ArrayList<JWindow>();
		BufferedImage img=ImageIO.read(plik2);
  		ImageIcon ikona=new ImageIcon(img);
  		BufferedImage img2=ImageIO.read(plik3);
  		ImageIcon ikonaa2=new ImageIcon(img2);
		        				...
		        				try {
									...
									ramka.addMouseListener(new MouseAdapter(){
										public void mouseClicked(MouseEvent event){
											...
											ramka.dispose();
											for(int no=0;no<Zdjecia.size();no++){
												JWindow tmp= Zdjecia.get(no);
												tmp.dispose();
											}
											//powrot();
										}
		 ...
		 //      lol.mouseDragged(arg0);
		        ...
		        taba[n].addMouseListener(new MouseAdapter(){
	        		...
	        		public void mouseExited(MouseEvent event){
	        			...
	        			nowa.dispose();
						for(int no=0;no<listaRamki.size();no++){
							JWindow tmp=listaRamki.get(no);
							tmp.dispose();
